...
class Application : public Jahley::App
{
 public:
        ...
        Jahley::App (settings, windowApp) // Call the constructor of the parent class 'Jahley::App' and pass the arguments.
    {
        ...
        camera->lookAt (Eigen::Vector3f (1.0f, 3.5f, 6.0f), Eigen::Vector3f (0.0f, 0.0f, 0.0f), Eigen::Vector3f (0.0f, 1.0f, 0.0f));
        ...
        model.init (camera, resourceFolder, repoFolder, commonFolder);
    }
